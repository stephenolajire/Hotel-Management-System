...
const ContainerOne = () => {
  return (
    <div className="w-full pt-4 md:pt-0 h-auto md:h-[60vh] bg-gray-100 rounded-lg relative flex flex-col gap-4 md:flex md:flex-row items-center md:justify-between px-4 sm:px-6 md:px-10 lg:px-15">
      <div className="w-full md:w-[40%] h-[40vh] relative pt-4 md:pt-0">
        <Image
          src="/top_2.jpg"
          alt="About Image"
          fill
      ...
      <div className="pb-4 md:pb-0 w-full md:w-[50%] h-full flex flex-col items-start justify-center">
